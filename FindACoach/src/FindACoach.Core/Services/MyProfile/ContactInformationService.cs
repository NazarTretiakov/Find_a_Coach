...
namespace FindACoach.Core.Services.MyProfile
{
    public class ContactInformationGetterService : IContactInformationGetterService
    {
        ...
        public ContactInformationGetterService(IUsersRepository usersRepository, IHttpContextAccessor httpContextAccessor)
        {
            _usersRepository = usersRepository;
            _httpContextAccessor = httpContextAccessor;
        }

        public async Task<ContactInformationToResponse> GetContactInformation()
        {
            ...
            return await _usersRepository.GetContactInformation(activeUserId);
        }
    }
}
