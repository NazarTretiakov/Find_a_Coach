...
{
    public class RecommendationsAdderService : IRecommendationsAdderService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IRecommendationsRepository _recommendationsRepository;

        public RecommendationsAdderService(IHttpContextAccessor httpContextAccessor, IRecommendationsRepository recommendationsRepository)
        {
            _httpContextAccessor = httpContextAccessor;
            _recommendationsRepository = recommendationsRepository;
        }

        public async Task AddRecommendation(AddRecommendationDTO dto)
        {
            ...
            await _recommendationsRepository.AddRecommendation(activeUserId, dto);
        }
    }
}
