...
namespace FindACoach.Infrastructure.Migrations
{
    ...
    [Migration("20251111084749_AddedContactInfomrmationVisibilityColumnToUsersTable")]
    partial class AddedContactInfomrmationVisibilityColumnToUsersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Activity.EventApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SearchPersonPanelId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SearchPersonPanelId");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Activity.Vote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Network.Connection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Network.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("NotifiedObjectId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.User.Recommendation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("RecommenderUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.IdentityEntities.User", b =>
                {
                    ...
                    b.Property<int>("ContactInformationVisibility")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Activity.EventApplication", b =>
                {
                    b.HasOne("FindACoach.Core.Domain.Entities.Activity.SearchPersonPanel", "SearchPersonPanel")
                        .WithMany()
                        .HasForeignKey("SearchPersonPanelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("SearchPersonPanel");
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.Activity.Vote", b =>
                {
                    b.HasOne("FindACoach.Core.Domain.Entities.Activity.SurveyOption", "SurveyOption")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("FindACoach.Core.Domain.Entities.User.Recommendation", b =>
                {
                    b.HasOne("FindACoach.Core.Domain.IdentityEntities.User", "RecommendedUser")
                        .WithMany("RecommendationsReceived")
                        .HasForeignKey("RecommendedUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("FindACoach.Core.Domain.IdentityEntities.User", "RecommenderUser")
