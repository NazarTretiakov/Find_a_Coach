        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCurrentlyWorkingHere = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PositionSkill", x => new { x.PositionsId, x.SkillsId });
                    table.ForeignKey(
                        name: "FK_PositionSkill_Positions_PositionsId",
                        column: x => x.PositionsId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PositionSkill_Skills_SkillsId",
                        column: x => x.SkillsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PositionSkill_SkillsId",
                table: "PositionSkill",
                column: "SkillsId");
        }
