<template>
  <div class="languages-section">
    <ul class="languages-section-items">
      ...
      <li v-for="(language, index) in languages" :key="language.languageId" class="languages-section-items_language">
        <ul class="languages-section-items_language-items">
          <li class="languages-section-items_language-items_name"><router-link :to="`/user-profile/${id}/languages/#${language.languageId}`" class="languages-section-items_language-items_name-link"><h2 class="languages-section-items_language-items_name-element">{{ language.title }}</h2></router-link></li>
    ...
    <router-link class="languages-section-items_show-all-languages-link" :to="`/user-profile/${id}/languages`">
