        ...
        <ul class="education-section-items_education-items">
          <li class="education-section-items_education-items_title">
            <ul class="education-section-items_education-items_title-items">
              <li class="education-section-items_education-items_title-items_name"><router-link :to="`/my-profile/education/#${school.schoolId}`" class="education-section-items_education-items_title-items_name-link"><h2 class="education-section-items_education-items_title-items_name-element">{{ school.schoolName }}</h2></router-link></li>
          ...
          <li class="education-section-items_education-items_skills"><router-link :to="`/my-profile/education/#${school.schoolId}`" class="education-section-items_education-items_skills-link"><the-skills :skills="school.skillTitles"></the-skills></router-link></li>
        </ul>
...
export default defineComponent({
  ...
  setup() {
    ...
    async function loadSchools() {
      const result = await useGetLastTwoSchools(authenticationStore.userId)
