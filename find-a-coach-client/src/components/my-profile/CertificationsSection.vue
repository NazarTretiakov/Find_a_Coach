        ...
        <ul class="certifications-section-items_header-items">
          ...
          <li class="certifications-section-items_header-items_buttons">
            <ul class="certifications-section-items_header-items_buttons-items">
              <li class="certifications-section-items_header-items_buttons-items_add">
                <router-link to="/my-profile/add-certification" class="certifications-section-items_header-items_buttons-items_add-link">
                  <img src="../../assets/images/icons/add-icon.svg" alt="Add icon" class="certifications-section-items_header-items_buttons-items_add-element">
                </router-link>
              </li>
              <li class="certifications-section-items_header-items_buttons-items_edit">
                <router-link to="/my-profile/certifications" class="certifications-section-items_header-items_buttons-items_edit-link">
                  <img src="../../assets/images/icons/edit-icon.svg" alt="Edit icon" class="certifications-section-items_header-items_buttons-items_edit-element">
                </router-link>
              </li>
            </ul>
          </li>
      ...
      <li v-for="(certification, index) in certifications" :key="certification.certificationId" class="certifications-section-items_certification">
        <ul class="certifications-section-items_certification-items">
          <li class="certifications-section-items_certification-items_title">
            <ul class="certifications-section-items_certification-items_title-items">
              <li class="certifications-section-items_certification-items_title-items_name">
                <router-link :to="`/my-profile/certifications/#${certification.certificationId}`" class="certifications-section-items_certification-items_title-items_name-link">
          ...
          <li class="certifications-section-items_certification-items_skills">
            <router-link :to="`/my-profile/certifications/#${certification.certificationId}`" class="certifications-section-items_certification-items_skills-link">
...
export default defineComponent({
  ...
  setup() {
    ...
    async function loadCertifications() {
      const result = await useGetLastTwoCertifications(authenticationStore.userId)
