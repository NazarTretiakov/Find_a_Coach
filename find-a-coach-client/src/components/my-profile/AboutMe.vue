<template>
  <div class="about-me">
    <ul class="about-me-header">
      ...
      <li class="about-me-header-edit"><router-link to="/my-profile/edit-about-me" class="about-me-header-edit-link"><img src="../../assets/images/icons/edit-icon.svg" alt="Edit icon" class="about-me-header-edit-icon"></router-link></li>
    </ul>
