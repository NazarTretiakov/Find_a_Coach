<template>
  <div class="activities">
    <div class="activities-title">
      <img class="activities-title-icon" src="@/assets/images/icons/save-icon.svg" alt="Save icon">
      <h1 class="activities-title-inscription">Saved activities</h1>
    </div>
    ...
    <div v-if="!isLoading && activities.length == 0" class="activities-items_empty-state">
      ...
      <span class="activities-items_empty-state-inscription">You have no saved activities yet.</span>
    </div>
...
import useGetSavedActivities from '@/composables/my-profile/settings/useGetSavedActivities'
...
export default defineComponent({
  ...
  setup() {
    ...
    async function loadActivities() {
      ...
      const result = await useGetSavedActivities(authenticationStore.userId, page.value, pageSize)
