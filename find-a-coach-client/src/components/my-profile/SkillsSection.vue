        ...
        <ul class="skills-section-items_header-items">
          ...
          <li class="skills-section-items_header-items_buttons">
            <ul class="skills-section-items_header-items_buttons-items">
              <li class="skills-section-items_header-items_buttons-items_edit">
                <router-link to="/my-profile/skills" class="skills-section-items_header-items_buttons-items_edit-link">
                  <img src="../../assets/images/icons/edit-icon.svg" alt="Edit icon" class="skills-section-items_header-items_buttons-items_edit-element" />
                </router-link>
              </li>
            </ul>
          </li>
      ...
      <li v-for="(skill, index) in skills" :key="skill.skillId" class="skills-section-items_skill">
        <ul class="skills-section-items_skill-items">
          <li class="skills-section-items_skill-items_name">
            <router-link :to="`/my-profile/skills/#${skill.skillId}`" class="skills-section-items_skill-items_name-link">
...
export default defineComponent({
  setup() {
    ...
    async function loadSkills() {
      const result = await useGetTwoSkillsWithMostUsages(authenticationStore.userId)
