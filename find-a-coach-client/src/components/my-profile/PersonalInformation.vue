    ...
    <ul class="personal-information-items">
      <li class="personal-information-items_left-side">
        <ul class="personal-information-items_left-side-items">
          ...
          <li class="personal-information-items_left-side-items_button"><add-profile-section class="personal-information-items_left-side-items_button">Add profile section</add-profile-section></li>
        </ul>
      </li>
