<template>
  <div class="activities">
    <ul class="activities-items">
      <li v-for="(activity, index) in activities" :key="activity.id" class="activities-items_activity">
        ...
        <div class="activities-items_activity-delete" @click="deleteActivity(activity.id)">
          <span class="activities-items_activity-delete-inscription">Delete activity</span>
        </div>
      </li>
    </ul>
