...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { post, isLoading, toggleLike, toggleSave , inputFieldAddCommentContent, activeUserEmail, createComment, formatDate, deleteComment, loadMoreComments, isLoadMoreCommentsButtonVisible }
  }
});
</script>
